...
private:
    enum enMainMenueOptions {
        ...
        eManageUsers = 7, eLoginRegisterList = 8, eCurrencyExchang = 9, eExit = 10
    };
    ...
    {
        clsLoginRegisterListScreen::ShowLoginRecordsList();
    }

    static void _ShowCurrencyExchangScreen()
    {
        //cout << "\nCurrencyExchang Screen wil be here...\n";
        clsCurrencyExchangScreen::ShowCurrencyExchingScreen();
    }
    ...
    static void _PerfromMainMenueOption(enMainMenueOptions MainMenueOption)
    {
        ...
        case enMainMenueOptions::eCurrencyExchang:
        ...
        case enMainMenueOptions::eExit:
            //_ShowEndScreen();
            // The main funcation to handl it.
            break;
        }
    }
...
public:
    ...
    static void ShowMainMenue()
    {
        ...
        cout << setw(37) << left << "" << "\t[9] CurrencyExchang.\n";
