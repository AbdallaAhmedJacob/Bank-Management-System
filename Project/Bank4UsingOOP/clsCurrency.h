...
private:
    ...
    static clsCurrency _ConvertLinetoCurrencyObject(string Line, string Seperator = "#//#")
    {
        ...
        return clsCurrency(_enMode::UpdateMode, vCurrencyData[0], vCurrencyData[1], vCurrencyData[2],
...
public:
    ...
    {
        Country = clsString::UpperAllLetter(Country);
        ...
        if (MyFile.is_open())
        {
            ...
            {
                clsCurrency Currency = _ConvertLinetoCurrencyObject(Line);
                if (clsString::UpperAllLetter(Currency.Country()) == Country)
                {
                    MyFile.close();
                    return Currency;
                }
    ...
    float ConvertToOtherCurrency(float Amount, clsCurrency Currecy2)
    {
        return ConvertToUSD(Amount) * Currecy2.Rate();
    }
